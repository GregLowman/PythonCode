"""OOP challenge: Song, Album, and Artist classes loading a tab-delimited library; simplified Artist stores name as str."""
...
class Artist:
    ...
    Methods:
        add_album: Use to ass a new album to the artist's albums list
    """
...
def load_data():
    """Read albums.txt and build a list of Artist objects with nested Albums and Songs."""
    artist_list = []
