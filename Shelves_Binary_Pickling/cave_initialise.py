"""Initialise shelve databases for the cave adventure game: locations and vocabulary."""
import shelve

locations = shelve.open("cave_loc", writeback=True)
...
vocabulary = shelve.open("vocab", writeback=True)
