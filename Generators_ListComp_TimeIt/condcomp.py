"""Conditional list comprehensions: filtering and multi-condition expressions on a menu list."""
menu = [
    ["egg", 'spam', 'bacon'],
    ['egg', 'sausage', 'bacon'],
    ['egg', 'spam'],
...
fussy_meals = [meal for meal in menu if "spam" in meal or "eggs"
               in meal if not ("bacon" in meal and "sausage" in meal)]
